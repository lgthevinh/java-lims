...
public class UserDAO extends DatabaseManager {
    ...
    public static User getUserBySocialId(String socialId) throws SQLException, ParseException {
        Connection conn = getConnection();
        Statement statement = conn.createStatement();
        ResultSet resultSet = statement.executeQuery("SELECT * FROM User WHERE email = '%s'".formatted(socialId));
    ...
    public static User getUserByPhoneNumber(String phoneNumber) throws SQLException, ParseException {
        Connection conn = getConnection();
        Statement statement = conn.createStatement();
        ResultSet resultSet = statement.executeQuery("SELECT * FROM User WHERE email = '%s'".formatted(phoneNumber));
