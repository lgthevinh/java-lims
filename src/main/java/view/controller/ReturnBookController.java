...
public class ReturnBookController {
    ...
    private void returnBook() {
        try {
            ...
            if (currentUser == null || selectedBorrowDetail.getBorrowerId() != currentUser.getUserId()) {
                Alert alert = new Alert(Alert.AlertType.ERROR);
                alert.setTitle("Permission Denied");
                alert.setHeaderText("You cannot return this book.");
                alert.setContentText("This book was not borrowed by you.");
                alert.showAndWait();
                return;
            }
